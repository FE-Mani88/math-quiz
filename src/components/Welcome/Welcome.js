                                ...
                                <section className='flex flex-col basis-[50%] sm:mt-[100px] mt-12 mx-1.5 text-center'>
                                    ...
                                    <div className='text-center mt-6'>
                                        <div className='flex justify-evenly'>
                                            <button className=''>
                                                <Link to='/wquiz' className='bg-gradient-to-r from-[#663ddf] to-[#aa00ff] pl-4 pr-4 pt-2 pb-2 rounded-lg animate-pulse gap-2.5 text-white hover:bg-purple-700 active:bg-purple-800 transition-all text-2xl flex items-center'>
