        ...
        <div class="chip0 cbk2v cuk8q clv5h  cz8nf c9loe cum4w cwh80">
          <header class="c307p cvtc3 c0ayg">
            <div class="cbl28 c0g2c coaq6 cb0ik">
              <div class="chip0 cglp6 c4mnq cd10w cdoit">
                ...
                <nav class="chip0 cxgjn">
                  ...
                  <ul class="chip0 cxgjn cutr6 c4mnq cbv5p">
                    ...
                    <li class="c8h5l">
                      <a class="c2pi2 c0ayg c4wey cl6ef cf4pm cqbpd cxmkl c4aul c76qn" href="#0">
                        Get Started <span class="cfe40 cr1tk c56im cv73b c6m7s ckwz7 ccx8x">-&gt;</span>
                      </a>
                    </li>
                  </ul>
        ...
        <div className="cbl28 czcad ckxd8 c4qns czwux cohxx">
          <div data-aos="zoom-out" className="aos-init aos-animate">
            <div className="c8a4e ciljg cmgtq czrr8 c4a1n coaq6 cld06 cimbm clnec cm1n3 cv4y4 cjzl6 cfgdq cfqr8 ctz45 cyb34 c6760 cs42d ca9no">
              <div className="ckdyj">Launching Infinite Workspaces. <a className="cpfyo c4mnq cazq3 ce7rf cdm1x c6m7s ckwz7 c76qn" href="#0">Learn
                  More
                  <span className="cfe40 cr1tk cv73b c6m7s ckwz7 ccx8x">-&gt;</span></a></div>
            </div>
          </div>
          <h1 className="cx0om ciljg cejd3 aos-init aos-animate" data-aos="zoom-out" data-aos-delay={100}>
            Where the world builds <em className="font-italic">software</em></h1>
          <p className="cyl8w cbqc4 ckdyj aos-init aos-animate" data-aos="zoom-out" data-aos-delay={200}>
            ...
            and
            get beautiful results forever.</p>
          <div className="cbl28 cn9oi cu0vn cdjip c4t8e c9mpo cvuia cqmlm cjwgj aos-init aos-animate" data-aos="zoom-out" data-aos-delay={300}>
            <div>
              <a className="cxykh c0ayg c4wey cl6ef cf4pm cqbpd cxmkl c4aul c76qn" href="#0">
                Get Started For Free <span className="cfe40 cr1tk c56im cv73b c6m7s ckwz7 ccx8x">-&gt;</span>
              </a>
            </div>
            <div>
              <a className="cxykh c0ayg c4wey ckoll c2xk9 clnec cxmkl crzek" href="#0">Explore
                Docs</a>
            </div>
          </div>
        </div>
  ...
  <section>
    <div className="cbl28 c0g2c coaq6 cb0ik">
      <div className="c25y8 cydxx ckewl">
        {/* Items */}
        <div className="cbl28 c8bbi c4ebt cyhed c25ra ckch3 cwu35">
          {/* Item */}
          <div className="ckl7j chip0 c4mnq c32kt chs2t cfba1 aos-init aos-animate" data-aos="zoom-out">
            <svg className="ceb8g cfn3c" width={124} height={24} viewBox="0 0 124 24" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Item */}
          <div className="ckl7j chip0 c4mnq c32kt chs2t cfba1 aos-init aos-animate" data-aos="zoom-out" data-aos-delay={100}>
            <svg className="ceb8g cfn3c" width={83} height={30} viewBox="0 0 83 30" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Item */}
          <div className="ckl7j chip0 c4mnq c32kt chs2t cfba1 aos-init aos-animate" data-aos="zoom-out" data-aos-delay={200}>
            <svg className="ceb8g cfn3c" width={125} height={39} viewBox="0 0 125 39" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Item */}
          <div className="ckl7j chip0 c4mnq c32kt chs2t cfba1 aos-init aos-animate" data-aos="zoom-out" data-aos-delay={300}>
            <svg className="ceb8g cfn3c" width={113} height={30} viewBox="0 0 113 30" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Item */}
          <div className="ckl7j c69o1 chip0 c4mnq c32kt chs2t cfba1 aos-init aos-animate" data-aos="zoom-out" data-aos-delay={400}>
            <svg className="ceb8g cfn3c" width={109} height={33} viewBox="0 0 109 33" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="cbl28 c0g2c coaq6 cb0ik">
      <div className="cyo0e c2n62">
        ...
        <div className="czfa1 ckxd8 c2e3f">
          <h2 className="c4cmz cejd3 aos-init aos-animate" data-aos="zoom-out">Focus on solving bigger
            problems</h2>
        </div>
        ...
        <div className="cbl28 c8bbi c4ebt c4v1u cpkit cckpn ct4ea c5a57">
          {/* 1st item */}
          <div className="chip0 cuk8q c4mnq aos-init aos-animate" data-aos="zoom-out">
            <div className="cvx4v">
            ...
            <h4 className="cqwf5 c6u0s ckxd8 crnw4">Ready for the future</h4>
            <p className="ckxd8 cblub ckdyj">A flexible foundation that evolves with complex
              ecosystem.
            </p>
          </div>
          {/* 2nd item */}
          <div className="chip0 cuk8q c4mnq aos-init aos-animate" data-aos="zoom-out" data-aos-delay={200}>
            <div className="cvx4v">
              <svg width={56} height={56} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                <defs>
          ...
          {/* 3rd item */}
          <div className="chip0 cuk8q c4mnq aos-init aos-animate" data-aos="zoom-out" data-aos-delay={400}>
            <div className="cvx4v">
              <svg width={56} height={56} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                <defs>
